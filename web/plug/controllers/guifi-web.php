...
function credentials_post()
{
    ...
    return(array('type' => 'render','page' => _check_credentials(
        $_POST,
...
function refresh_credentials_post()
{
    ...
    return(array('type' => 'render','page' => _recheck_credentials(
        $_POST,
