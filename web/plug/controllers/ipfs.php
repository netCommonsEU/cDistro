...
function index(){
	...
	#$page .= addButton(array('label'=>t('Create IPFS node'),'href'=>$staticFile.'/ipfs/initialize'));
...
#function _ipfssource($description) {
#	global $ipfspath,$ipfsprogram,$title,$ipfsutils,$avahi_type,$port;
#	$page = "";
...
#	$cmd = $ipfsutils." publish "$port" "$description;
#  	execute_program_detached($cmd);
#	$page .= t($ipserver);
...
#	$page .= ptxt($temp);
#	$page .= addButton(array('label'=>t('Back'),'href'=>$staticFile.'/ipfs'));
# 	return($page);
#}
