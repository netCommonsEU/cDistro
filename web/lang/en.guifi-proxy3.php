...
//Common
addS ("guifi-proxy3_common_title","Guifi Proxy3");
...
//Alerts
addS ("guifi-proxy3_alert_not_installed","Guifi Proxy3 is not installed");
addS ("guifi-proxy3_alert_not_registered","This Cloudy device is not registered at Guifi.net");
//addS ("","");
//addS ("","");
//addS ("","");
//addS ("","");
...
addS ("guifi-proxy3_button_install","Install Guifi Proxy3");
//addS ("","");
//addS ("","");
//addS ("","");
//addS ("","");
...
//form
addS ("guifi-proxy3_form_url","URL");
...
addS ("guifi-proxy3_form_node","Service node number");
addS ("guifi-proxy3_form_node_tooltip","The number of the proxy service at Guifi.net's website (e.g. http://guifi.net/node/123456)");
...
//index
addS ("guifi-proxy3_index_subtitle","A federated proxy service for the Guifi.net Community Network");
addS ("guifi-proxy3_index_description1",'Guifi Proxy3 is a package that provides a federated proxy service with <a href="http://en.wiki.guifi.net/wiki/LDAP">LDAP authentication</a> for the Guifi.net Community Network. It is based on <a href="http://www.squid-cache.org">Squid</a>, a free software caching proxy for the Web supporting HTTP, HTTPS, FTP, and more.');
addS ("guifi-proxy3_index_description2",'You can check this wiki page for more information: <a href="http://en.wiki.guifi.net/wiki/Proxy_Server">http://en.wiki.guifi.net/wiki/Proxy_Server</a>');
addS ("guifi-proxy3_index_guifi_proxy3_status","Guifi Proxy3 status:");
...
//install
addS ("guifi-proxy3_install_subtitle","Guifi Proxy3 installation and configuration");
//addS ("","");
//addS ("","");
//addS ("","");
//addS ("","");
