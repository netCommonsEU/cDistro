...
// web/plug/controllers/default.php

//Common
addS("default_common_cloudy", "Cloudy");
addS("default_common_description", "El núvol per a xarxes comunitàries a les teves mans");
...
//index
addS("default_index_systeminfo", "Informació del dispositiu");
addS("default_index_address", "Adreça i port: ");
addS("default_index_hostname", "Nom del dispositiu: ");
...
addS("default_generic_I_U_pre_Install", "S'està instal·lant el paquet ");
addS("default_generic_I_U_post_Install", ", si us plau, espereu...");
addS("default_generic_I_U_pre_Uninstall", "S'està desinstal·lat el paquet ");
...
addS("default_realInstall_not_installed_pre", "El paquet ");
...
addS("default_realUninstall_not_installed_pre", "El paquet ");
