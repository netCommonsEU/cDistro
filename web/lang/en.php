...
// lib/view.php
addS("lib-view_button_back", "Back");
addS("lib-view_button_install_pre", "Install package ");
addS("lib-view_button_install_post", "");
addS("lib-view_common_package_manager_title", "Package manager");
addS("lib-view_common_package_manager_subtitle", "Cloudy automated package installer and uninstaller");
addS('lib-view_package_not_installed_to_install', 'The following package is going to be installed:');
addS('lib-view_package_not_installed_text', 'Click on the button below to proceed with the installation. Required package dependencies will be automatically installed.');
