...
addS ("caracalapi_saved_config", "Updated config file.");

// Text
addS ("caracalapi_title","Caracal REST API");
addS ("caracalapi_subtitle","REST API and WebUI for the CaracalDB Distributed Key-Value Store.");
addS ("caracalapi_description",'A JSON based REST API to access CaracalDB from external services. Also contains a simple WebUI as a frontend for the API. See <a href="https://github.com/CaracalDB/CaracalDB">CaracalDB on Github</a> for more information.');
addS ("caracalapi_status", "Status");
addS ("caracalapi_config_file", "Config File");
addS ("caracalapi_config_edit", "Configure");
addS ("caracalapi_config_path", "Current file is at ");
addS ("caracalapi_log", "Log");
addS ("caracalapi_log_path", "Current log file is at ");

addS ("caracalapi_scroll_down", "Scroll Down");

// Buttons
addS ("caracalapi_button_install", "Install");
addS ("caracalapi_button_uninstall", "Uninstall");

addS ("caracalapi_button_start", "Start API");
addS ("caracalapi_button_stop", "Stop API");

addS ("caracalapi_button_save", "Save Config");

addS ("caracalapi_button_status", "Status");
...
addS ("caracalapi_form_localip", "CaracalDB Client Address");
addS ("caracalapi_form_localport", "CaracalDB Client Port");
addS ("caracalapi_form_webaddr", "Hostname for the REST API");
addS ("caracalapi_form_webport", "Port for the REST API");
