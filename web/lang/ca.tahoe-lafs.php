...
addS ("tahoe-lafs_alert_storage_not_created","Encara no s'ha creat el node d'emmagatzematge de The Tahoe-LAFS");
addS ("tahoe-lafs_alert_storage_running","El node d'emmagatzematge de Tahoe-LAFS storage està en marxa");
...
addS ("tahoe-lafs_createintroducer_subtitle","Creció d'un introducer");
...
addS ("tahoe-lafs_flash_restarting_storage","S'està reiniciant el node d'emmatzematge de Tahoe-LAFS...");
addS ("tahoe-lafs_flash_starting_introducer","S'està arrencant l'introducer de Tahoe-LAFS...");
addS ("tahoe-lafs_flash_starting_storage","S'està arrencant el node d'emmatzematge de Tahoe-LAFS...");
...
//index
addS ("tahoe-lafs_index_description1","Tahoe-LAFS és un sistema d'emmatzematge al núvol lliure i obert.");
...
addS ("tahoe-lafs_index_instructions_1","Per desplegar una xarxa d'emmatzematge amb Tahoe-LAFS necessiteu un <strong>introducer</strong> i múltiples <strong>nodes d'emmatzematge</strong> distribuïts per la xarxa.");
...
addS ("tahoe-lafs_introducer_instructions_1","Per desplegar una xarxa d'emmatzematge amb Tahoe-LAFS necessiteu un <strong>introducer</strong> i múltiples <strong>nodes d'emmatzematge</strong> distribuïts per la xarxa.");
...
addS ("tahoe-lafs_node_instructions_1","Per desplegar una xarxa d'emmatzematge amb Tahoe-LAFS necessiteu un <strong>introducer</strong> i múltiples <strong>nodes d'emmatzematge</strong> distribuïts per la xarxa.");
...
addS ("tahoe-lafs_uninstall_result","Resultat del procés de Desinstal·dació:");
